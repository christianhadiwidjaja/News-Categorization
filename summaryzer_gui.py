...
tab_control.add(tab4, text=f'{"Classifier ":^20s}')
...
label3 = Label(tab4, text= 'Classifier',padx=5, pady=5)
label3.grid(column=0, row=0)
...
def get_summary():
	...
	final_text = bert_summarizer(raw_text)
	print(final_text)
...
# COMPARER TAB
l1=Label(tab4,text="Enter Text To Classify")
l1.grid(row=1,column=0)
...
button4=Button(tab4,text="Bert",command=use_bert, width=12,bg='#03A9F4',fg='#fff')
...
# About TAB
about_label = Label(tab5,text="Summaryzer GUI V.0.0.1 \n Christian Imanuel - 2301851175 \n Jason Sebastian Kusuma - 2301869235 \n Valentinus Jovel - 2301870003",pady=5,padx=5)
